...
```
{
   ...
   off: функция, которая отрабатывает после ВЫключения фичи,
}
```

Для автоматического удаления фичи использоваьт скрипт remove-feature.ts, который принимает 2 аргумента
